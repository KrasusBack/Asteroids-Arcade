...
public abstract class DeathAnimationCreator : MonoBehaviour
{
    public static void CreatePlayerDeathEffect()
    {
        ...
        Instantiate(GameCore.Instance.References.PrefabReferences.PlayerDestroyParticleEffect,
    ...
    {
        CreateDestroyEffect(objTransform, GameCore.Instance?.References.PrefabReferences.CommonDestroyParticleEffect);
    }
