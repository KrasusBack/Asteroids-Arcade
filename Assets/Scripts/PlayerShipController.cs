...
public class PlayerShipController : MonoBehaviour
{
    ...
    private void RotateHandler()
    {
        ...
        _rigidBody.rotation += rotationSpeed * -horizontalAxisInput;
    }
    ...
    private void MoveForwardHandler()
    {
        ...
        _rigidBody.AddRelativeForce(Vector2.right * movementVelocity);
    }
    ...
    private void ShootHandler()
    {
        ...
        var posOffset = _rigidBody.position + ((_boxCollider2D.size.x / 2 + offsetFromTheShip) * MathfExtentions.DegreeToVector2(transform.eulerAngles.z));
